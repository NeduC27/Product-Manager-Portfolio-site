  ...
  gl_FragColor = color;
      ...
      const loop = t => {
        ...
        try {
          ...
          // Renderer/context was likely torn down mid-frame — stop the loop.
          return;
        }
      };
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer) {
          try {
            ...
            // Context or canvas may already be gone if the component
            // unmounted quickly — safe to ignore during teardown.
          }
        }
